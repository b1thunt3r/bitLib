<?php
namespace Bit0\DataSource\Linq;
...
{    
    ...
    public static function From(Array &$dataSource = array())
    {
        return new Plinq($dataSource);
    }
    ...
    {
        $this->rewind();
        $slice = array_slice((Array)$this, $count, $this->count());
